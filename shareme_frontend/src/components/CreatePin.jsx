...
const CreatePin = ({ user }) => {
  ...
  //considering these whether can be optimized?
  ...
  const uploadImage = (e) => {
    ...
    // console.log(type);
    if (imageType.find((type) => type === type)) {
  ...
  const savePin = () => {
    if (title && about && destination && imageAsset?._id && category) {
      ...
      //need to use redux to manage the states of feed and pins
              ...
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-32 text-gray-400">
                    Use high-quality JPG, SVG, PNG, GIF less than MB
                  </p>
                  <input
                    type="file"
                    name="upload-image"
